...
def get_favorites():
    ...
    return jsonify ({"msg":"ok", "result":favorites_serialized}), 200
...
def add_favorite_planet(planet_id):
    ...
    new_favorite_planet = Favorite(planet_id=planet_id)
...
def add_favorite_people(people_id):
    ...
    favorite_people = Favorite(character_id=people_id)
...
def delete_favorite_people(people_id):
    favorite_people = Favorite.query.filter_by(character_id=people_id).first()
    if favorite_people:
